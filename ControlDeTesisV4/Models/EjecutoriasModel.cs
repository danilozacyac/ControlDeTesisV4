...
namespace ControlDeTesisV4.Models
{
    public class EjecutoriasModel
    {
        ...
        public void SetNewProyectoEjecutoria(Ejecutorias ejecutoria)
        {
            ...
            try
            {
                ejecutoria.IdEjecutoria = this.GetLastId("Ejecutorias", "IdEjecutoria");
        ...
        public void SetNewObservacion(Observaciones observacion, int idEjecutoria)
        {
            ...
            try
            {
                observacion.IdObservacion = this.GetLastId("ObservacionesEjecutoria", "IdObservacion");
                ...
                sSql = "INSERT INTO Ejecutorias (IdObservacion,IdEjecutoria,Foja,Parrafo,Renglon,Dice,DicePlano,SeSugiere,SeSugierePlano,Aceptada) " +
        ...
        public void SetPrecedentes(PrecedentesTesis precedente, int idTesis)
        {
            ...
            try
            {
                ...
                precedente.IdPrecedente = this.GetLastId("PrecedentesEjecutorias", "IdPrecedente");
                ...
                sSql = "INSERT INTO PrecedentesEjecutorias (IdPrecedente,IdTesis,IdTipoAsunto,NumAsunto,YearAsunto,FResolucion,FResolucionInt,IdPonente,Promovente) " +
        ...
        public void UpdateObservacion(Observaciones observacion)
        {
            ...
            try
            {
                ...
                sSql = "UPDATE ObservacionesEjecutoria SET IdEjecutoria = @IdEjecutoria, Foja = @Foja,Parrafo = @Parrafo,Renglon = @Renglon,Dice = @Dice,DicePlano = @DicePlano,SeSugiere = @SeSugiere,SeSugierePlano = @SeSugierePlano, Aceptada = @Aceptada " +
        ...
        public void UpdatePrecedentes(PrecedentesTesis precedente)
        {
            ...
            try
            {
                ...
                dr.BeginEdit();
                dr["IdEjecutoria"] = precedente.IdTesis;
                dr["IdTipoAsunto"] = precedente.TipoAsunto;
                dr["NumAsunto"] = precedente.NumAsunto;
                dr["YearAsunto"] = precedente.YearAsunto;
                ...
                sSql = "UPDATE PrecedentesEjecutorias SET (IdTesis = @IdTesis,IdTipoAsunto = @IdTipoAsunto,NumAsunto = @NumAsunto,YearAsunto = @YearAsunto,FResolucion = @FResolucion," +
